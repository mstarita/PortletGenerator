<%@page session="false" contentType="text/html" pageEncoding="UTF-8" 
	import="${packageName}.Edit${portletName}ModelBean, ${packageName}.${portletName}Portlet, java.util.Locale"
%>
<%
String flexFileName = request.getContextPath() + "/${portletName}/view.swf";
...
<script language="javascript" >
	function resizeContainer(height) {
		var div = document.getElementById("${portletName?uncap_first}ViewSwfWrapper");
		div.style.height = height + "px";
	}
</script>

<div id="${portletName?uncap_first}ViewSwfWrapper" style="overflow: auto; overflow-y:hidden">
	<object
		border="none"
